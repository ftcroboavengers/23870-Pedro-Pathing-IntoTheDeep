...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        //[RAC] changing to encoder position
        forwardEncoderPose = new Pose(-143.675/25.4, 0.0, 0);
        strafeEncoderPose = new Pose(-143.675/25.4, 84/25.4, Math.toRadians(90));

        hardwareMap = map;

        //[RAC] No change to imu name
